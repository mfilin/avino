...
import styles from './PrivacyContainer.module.scss';
...
const PrivacyContainer: React.FC = ({}) => {
  return (
    <div className={styles.PrivacyContainer}>
      ...
      <Title as="h2" colorMode="grey">
        1. ОБЩИЕ ПОЛОЖЕНИЯ{' '}
      </Title>
      <Text level="s12h16w400" as="p">
        {' '}
        ...
        безопасности персональных данных, предпринимаемые ООО "ВИНОГРАД НЕ
        ВИНОВАТ" (далее – Оператор).
      </Text>{' '}
      <Text level="s12h16w400" as="p">
      ...
      <Text level="s12h16w400" as="p">
        ...
        <Link href="https://vinogradnevinovat.ru">
          <Text level="s12h16w400" colorMode="orange">
            https://vinogradnevinovat.ru
          </Text>
        </Link>{' '}
        .
      </Text>{' '}
      ...
      <Text level="s12h16w400" as="p">
        ...
        удалению или уточнению не полных или неточных данных.
      </Text>{' '}
      <Text level="s12h16w400" as="p">
      ...
      <Text level="s12h16w400" as="p">
        ...
        почты vnv.shop@mail.ru с пометкой «Отказ от уведомлений о новых
      ...
      <Text level="s12h16w400" as="p">
        ...
        <Text level="s12h16w400" as="p">
          ...
          <ul className={styles.List}>
            ...
            <li>
              {' '}
              – уставные документы Оператора; – договоры, заключаемые между
              оператором и субъектом персональных данных; – федеральные законы,
        ...
        <Text level="s12h16w400" as="p">
          ...
          волей и в своем интересе.<Title as="h2" colorMode="grey"></Title> 9.
        ...
        <Text level="s12h16w400" as="p">
          ...
          vnv.shop@mail.ru с пометкой «Актуализация персональных данных».
        </Text>{' '}
        <Text level="s12h16w400" as="p">
          ...
          на электронный адрес Оператора vnv.shop@mail.ru с пометкой «Отзыв
      ...
      <Text level="s12h16w400" as="p">
        ...
        Оператору с помощью электронной почты vnv.shop@mail.ru.
      </Text>{' '}
      <Text level="s12h16w400" as="p">
      ...
      <Text level="s12h16w400" as="p">
        ...
        Интернет по адресу{' '}
        <Link href="https://vinogradnevinovat.ru/privacy">
          <Text level="s12h16w400" colorMode="orange">
            https://vinogradnevinovat.ru/privacy
          </Text>
        </Link>
        .
      </Text>
