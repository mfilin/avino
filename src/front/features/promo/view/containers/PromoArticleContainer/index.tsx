...
const PromoArticleContainer: React.FC<IOwnProps> = (props) => {
    return(
        <>
                ...
                <div className="offer">
                    ...
                    <div className="offer__media">
                        <div className="offer__image">
                            <img src="images/offer_image_3.jpg" className="img-cover" alt="" />
                        </div>
                    </div>
                    <div className="offer__content">
                        ...
                        <div className="offer__slider">
                            <div className="swiper" data-offer>
                                <Swiper
                                        ...
                                        <div className="item item-offer">
                                                ...
                                                <button type="button" className="item__favorite" data-add-favorite>
                                                    <i>
                                                        <svg className="ico-svg" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                                            <use xlinkHref="images/sprites/sprite.svg#heart-small" xmlnsXlink="http://www.w3.org/1999/xlink"></use>
                                                        </svg>
                                                    </i>
                                                </button>
                                            ...
                                            <div className="item__content">
                                                                ...
                                                                {[...Array(5)].map((_, i) => (
                                                                    <div className="rating__star" key={i}>
                                                                        <svg className="ico-svg" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                                            <use xlinkHref="images/sprites/sprite.svg#star" xmlnsXlink="http://www.w3.org/1999/xlink"></use>
                                                                        </svg>
                                                                    </div>
                                                                ))}
                                                            </div>
                                                ...
                                                <div className="item__volumes">
                                                    {["800 мл", "1.2 л", "1.5 л"].map((volume, index) => (
                                                        <div className="item__volume" key={index}>{volume}</div>
                                                    ))}
                                                </div>
...
export default PromoArticleContainer;
